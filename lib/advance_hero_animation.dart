                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                PageRouteBuilder(
                                  pageBuilder: (context, animation, secondaryAnimation) => DetailScreen(image: image),
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [BoxShadow(color: image.color.withOpacity(0.3), blurRadius: 15, offset: Offset(0, 8))],
                              ),
                              child: Column(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                gradient: LinearGradient(
                                                  ...
                                                  colors: [image.color, image.color.withOpacity(0.8)],
                                                ),
                                              ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [widget.image.color, widget.image.color.withOpacity(0.8)],
                          ),
                        ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                                    ...
                                    child: FittedBox(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 4),
                                          Text(widget.image.location, style: TextStyle(fontSize: 16, color: Colors.grey[600])),
                                        ],
                                      ),
                                    ),
                                  ),
                          ...
                          SizedBox(height: 12),
                          Text(widget.image.description, style: TextStyle(fontSize: 16, color: Colors.grey[700], height: 1.6)),
